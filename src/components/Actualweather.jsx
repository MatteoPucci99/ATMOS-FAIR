...
const Actualweather = (props)=>{
    ...
    const getWeatherDetails = (details)=>{
        fetch(`https://api.openweathermap.org/data/2.5/weather?lat=${details[0].lat}&lon=${details[0].lon}&units=metric&lang=it&appid=af5fd8bce7d15b37aaa435f691fc2a00`)
        .then(res=>{
            if(res.ok){
                return res.json()
            } else {
    ...
    return (
        ...
        <ShowActualWeather data={weatherData}/>
